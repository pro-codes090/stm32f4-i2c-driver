...
int main(void) {
	...
	while (1) {
		...
		I2C_Send(&I2Chandle, &commandcode, 1, 0x68 , I2C_ENABLE_SR);

		I2C_Recieve(&I2Chandle,&len,1,0x68,I2C_ENABLE_SR);

		commandcode = 0x52 ;

		I2C_Send(&I2Chandle, &commandcode, 1, 0x68 , I2C_ENABLE_SR) ;

		I2C_Recieve(&I2Chandle,rcv_buf,len,0x68,I2C_DISABLE_SR);
